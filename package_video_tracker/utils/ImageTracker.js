...
ImageTracker.prototype.calcTransform = function (matches,
  ...
  // Both originPatternWidth and originPatternHeight are the origin size of the pattern image.
  var widthRatio = originPatternWidth / patternWidth;
  var heightRatio = originPatternHeight / patternHeight;
